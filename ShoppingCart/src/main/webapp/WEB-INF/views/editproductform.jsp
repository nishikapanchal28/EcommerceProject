...
<body>
<div class="container">
<c:url var="url" value="/admin/editProduct"></c:url>

<form:form action="${url }/${product.id}" commandName="product" method="POST" class="form-horizontal" enctype="multipart/form-data">
